...
(()=>{
    const e = new Error("Cannot find module './components/Homepage/Homepage'");
...
(()=>{
    const e = new Error("Cannot find module './components/Homepage/HeroSection'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module './components/Spacer'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
;
