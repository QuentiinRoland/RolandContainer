...
const ContainerAssistantModal = ({ isOpen, onClose })=>{
    ...
    const handleAnswer = (option)=>{
        ...
        if (step < questions.length - 1) {
            ...
            // Si c’est la dernière question, affiche la recommandation
            setStep(questions.length); // Cela déclenche l'affichage de la recommandation
        }
    };
...
//# sourceMappingURL=src_app_b6866f._.js.map